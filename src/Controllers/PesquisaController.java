...
public class PesquisaController{
	...
	/**
	 * Configura a estrategia que ser� usada para recomendar a proxima atividade 
	 * a ser executada
	 * @param estrategia O nome da estrat�gia
	 */
	 ...
	 * @param codigoPesquisa O codigo da Pesquisa que cont�m as atividades a ser
	 * sugerida
	 ...
	 * @param codigoAtividade O codigo da Atividade que ser� associada
	 ...
	 * @param codigoAtividade O codigo da Atividade que ser� deassociada
	 * @param atividadesRepositorio O repositorio de Atividade
